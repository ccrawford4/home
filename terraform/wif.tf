...
resource "google_service_account_iam_member" "workload_identity_binding_virgo" {
  service_account_id = google_service_account.home_cluster_sa.name
  role               = "roles/iam.workloadIdentityUser"
  member             = "principal://iam.googleapis.com/projects/${var.project_number}/locations/global/workloadIdentityPools/${google_iam_workload_identity_pool.home_cluster_pool.workload_identity_pool_id}/subject/system:serviceaccount:virgo:virgo"
}
