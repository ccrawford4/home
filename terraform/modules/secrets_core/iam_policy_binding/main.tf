...
resource "google_secret_manager_secret_iam_binding" "k8s_sa_secret_binding" {
  ...
  members = [
    "principal://iam.googleapis.com/projects/${var.project_number}/locations/global/workloadIdentityPools/${var.workload_identity_pool_id}/subject/system:serviceaccount:${var.k8s_namespace}:${var.k8s_service_account}",
